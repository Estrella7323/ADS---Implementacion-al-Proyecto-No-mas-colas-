...
public class Test {
    ...
    public static void main(String[] args) throws ParseException, ExceptionIsEmpty {
        ...
        Domicilio direccion4 = new Domicilio();
        CentroSalud p4 = new CentroSalud();
        System.out.println(p4);
        
        Domicilio direccion5 = new Domicilio();
        CentroSalud p5 = new CentroSalud();
        System.out.println(p5);
        
        Domicilio direccion6 = new Domicilio();
        CentroSalud p6 = new CentroSalud();
        System.out.println(p6);

        Domicilio direccion7 = new Domicilio();
        CentroSalud p7 = new CentroSalud();
        System.out.println(p7);
        
        Domicilio direccion8 = new Domicilio();
        CentroSalud p8 = new CentroSalud();
